...
public class AddViewActivity extends AppCompatActivity {
    ...
    private void init(){
        ...
        navigationView.titleItems(tabText)
                ...
                .addAsFragment(false)
                .mode(NavigationView.MODE_ADD_VIEW)
                .addCustomView(view)
                .canScroll(true)
                        ...
                        if (position == 2) {
                            mHandler.post(new Runnable() {
                                ...
                                public void run() {
                                    //＋ 旋转动画
                                    if (flag) {
                                        navigationView.getCustomAddView().animate().rotation(180).setDuration(400);
                                    } else {
                                        navigationView.getCustomAddView().animate().rotation(0).setDuration(400);
                                    }
                                    flag = !flag;
                                }
                            });
